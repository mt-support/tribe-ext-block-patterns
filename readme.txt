=== The Events Calendar Extension: Block Patterns ===
...
A collection of block patterns for displaying event content.

== Description ==

This extension adds a collection of saved patterns to the WordPress block editor that can be used to display event content and information.
